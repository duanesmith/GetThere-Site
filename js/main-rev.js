...
var App = { init: function() { App.HomepageHeight();
	...
	$('.main_scroll_down').click(function () {$.scrollTo('#more_info',1000,{easing:'easeInOutExpo','axis':'y'});return false}); 
    ...
    Elements_animation: function() {
    	...
    	$('#about_gt').waypoint(function() {
            setTimeout(function(){$('.about_gt_anim1').addClass('animated fadeInUp')},0);
            setTimeout(function(){$('.about_gt_anim2').addClass('animated fadeInUp')},200);
            setTimeout(function(){$('.about_gt_anim3').addClass('animated fadeInUp')},400);
            setTimeout(function(){$('.about_gt_anim4').addClass('animated fadeInUp')},600);
            setTimeout(function(){$('.about_gt_anim5').addClass('animated fadeInUp')},800);
            setTimeout(function(){$('.about_gt_anim6').addClass('animated fadeInUp')},1000);
            setTimeout(function(){$('.about_gt_anim7').addClass('animated fadeInUp')},1200);
            setTimeout(function(){$('.about_gt_anim8').addClass('animated fadeInUp')},1400);
            setTimeout(function(){$('.about_gt_anim9').addClass('animated fadeInUp')},1600);
            setTimeout(function(){$('.about_gt_anim10').addClass('animated fadeInUp')},2000);
        }, { offset: '50%' });
